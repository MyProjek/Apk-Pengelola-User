...
public class DialogUser extends javax.swing.JDialog {
    ...
    public DialogUser(java.awt.Frame parent, boolean modal) {
        ...
        initComponents();
        try {
            ResultSet rs = Database.ambilData(
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtKecamatan, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        String sql = "INSERT users SET "
                + "user_longname ='" + txtNama.getText() + "',"
                + "user_login ='" + txtUsername.getText() + "',"
                + "user_password = md5('" + txtPassword.getText() + "'),"
                + "user_subcity ='" + txtKecamatan.getText()+"'";
        if (!PanelUser.id.equals("")){
